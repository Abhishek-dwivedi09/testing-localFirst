...
const options = {
  info: {
    version: "1.0.0",
    title: "LocalFirst-Merchant  WebApp API",
    description: "LocalFirst-Merchant  WebApp API documentation",
  },
  security: {
    BearerAuth: {
      type: "http",
  ...
  swaggerUIPath: "/v1/refferals/api-docs",
  exposeSwaggerUI: true,
  exposeApiDocs: false,
  apiDocsPath: "/v3/api-docs",
  notRequiredAsNullable: false,
  swaggerUiOptions: {
    customSiteTitle: "LocalFirst-Merchant | API Doc",
  },
};
